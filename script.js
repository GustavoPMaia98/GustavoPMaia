(function () {
  ...
  const I18N = {
    ...
    bio:{en:"My research focuses on exploring the origins and evolution of life in the universe, using chemistry to uncover the complex processes and mechanisms that may have led to life's emergence. A key aspect of my work involves mechanochemistry — the study of chemical reactions driven by mechanical forces. I investigate how mechanical energy, such as that produced by parent-body formation, asteroid gardening, or meteorite impacts, could have promoted the synthesis and transformation of organic molecules on the early Earth and other planetary bodies. Through this work, I aim to shed light on alternative pathways for prebiotic chemistry and demonstrate how mechanical activation might have played a crucial role in the emergence of life under extraterrestrial or extreme environments.",
         pt:"A minha investigação centra-se na exploração das origens e da evolução da vida no universo, usando a química para desvendar os processos e mecanismos complexos que poderão ter conduzido ao surgimento da vida. Um aspeto central do meu trabalho é a mecanoquímica — o estudo das reações químicas impulsionadas por forças mecânicas. Investigo como a energia mecânica, como a produzida pela formação de corpos progenitores, pelo asteroid gardening ou por impactos de meteoritos, poderá ter promovido a síntese e a transformação de moléculas orgânicas na Terra primitiva e noutros corpos planetários. Com este trabalho, procuro esclarecer vias alternativas para a química prebiótica e demonstrar como a ativação mecânica poderá ter desempenhado um papel crucial no surgimento da vida em ambientes extraterrestres ou extremos."},
