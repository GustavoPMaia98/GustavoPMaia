(function () {
  ...
  const I18N = {
    ...
    bio:{en:"I explore the mechanochemical reactions of plausibly extraterrestrial organic matter — using ball-milling and shock to recreate the impact events that pervaded the early Solar System — to understand how these forces transform life's molecular building blocks, and what that means for prebiotic chemistry and the origin of life.",
         pt:"Exploro as reações mecanoquímicas de matéria orgânica plausivelmente extraterrestre — recorrendo à moagem e ao choque para recriar os impactos que marcaram o Sistema Solar primitivo — para compreender como estas forças transformam os blocos moleculares da vida e o que isso significa para a química prebiótica e a origem da vida."},
